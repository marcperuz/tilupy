...
cmap_intervals["slope_10deg"]["coulomb"][15] = dict(
    hmax=[0.1, 0.5, 1, 5, 10, 25, 40], hfinal=[0.1, 0.2, 0.5, 1, 2, 3, 5]
)
cmap_intervals["slope_10deg"]["coulomb"][20] = dict(
    hmax=[0.1, 0.5, 1, 5, 10, 25, 40], hfinal=[0.1, 0.2, 0.5, 1, 2, 5, 10]
)
cmap_intervals["slope_10deg"]["coulomb"][25] = dict(
    hmax=[0.1, 0.5, 1, 5, 10, 25, 40], hfinal=[0.1, 0.5, 1, 2, 5, 10, 20]
)
